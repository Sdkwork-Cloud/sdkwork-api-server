...
impl SqliteAdminStore {
    ...
    pub async fn list_commerce_webhook_inbox_records(
        ...
        .await?;
        rows.into_iter()
            .map(Self::map_sqlite_commerce_webhook_inbox_row)
            .collect()
    }
    ...
    pub async fn find_commerce_webhook_inbox(
        ...
        .await?;
        row.map(Self::map_sqlite_commerce_webhook_inbox_row)
            .transpose()
    }
    ...
    pub async fn insert_commerce_webhook_delivery_attempt(
        ...
        .bind(&record.webhook_inbox_id)
        .bind(&record.processing_status)
        .bind(record.response_code.map(i64::from))
    ...
    pub async fn list_commerce_webhook_delivery_attempts(
        ...
        .await?;
        rows.into_iter()
            .map(Self::map_sqlite_commerce_webhook_delivery_attempt_row)
            .collect()
    }
    ...
    pub async fn list_commerce_refunds(&self) -> Result<Vec<CommerceRefundRecord>> {
        ...
        .await?;
        rows.into_iter()
            .map(Self::map_sqlite_commerce_refund_row)
            .collect()
    }
    ...
    pub async fn find_commerce_refund(
        ...
        .fetch_optional(&self.pool)
        .await?;
        row.map(Self::map_sqlite_commerce_refund_row).transpose()
    }
    ...
    pub async fn list_commerce_reconciliation_runs(
        ...
        .await?;
        rows.into_iter()
            .map(Self::map_sqlite_commerce_reconciliation_run_row)
            .collect()
    }
    ...
    pub async fn list_commerce_reconciliation_items(
        ...
        .await?;
        rows.into_iter()
            .map(Self::map_sqlite_commerce_reconciliation_item_row)
            .collect()
    }

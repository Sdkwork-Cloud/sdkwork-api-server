...
pub(crate) async fn apply_sqlite_commerce_jobs_schema(pool: &SqlitePool) -> Result<()> {
    sqlx::query(
    ...
    ensure_sqlite_column_if_table_exists(
        ...
        "latest_payment_attempt_id TEXT",
    )
    .await?;
    ensure_sqlite_column_if_table_exists(
        pool,
    ...
    sqlx::query(
        "CREATE TABLE IF NOT EXISTS ai_commerce_payment_attempts (
            ...
            error_code TEXT,
            error_message TEXT,
            initiated_at_ms INTEGER NOT NULL DEFAULT 0,
    ...
    sqlx::query(
        "CREATE TABLE IF NOT EXISTS ai_commerce_webhook_inbox (
            ...
            first_received_at_ms INTEGER NOT NULL DEFAULT 0,
    ...
    sqlx::query(
        "CREATE TABLE IF NOT EXISTS ai_commerce_reconciliation_runs (
            ...
            provider TEXT NOT NULL,
            payment_method_id TEXT,
            scope_started_at_ms INTEGER NOT NULL DEFAULT 0,
            scope_ended_at_ms INTEGER NOT NULL DEFAULT 0,

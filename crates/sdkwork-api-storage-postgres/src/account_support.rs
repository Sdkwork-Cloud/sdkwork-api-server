...
pub(crate) fn parse_account_type(value: &str) -> Result<AccountType> {
    match value {
        ...
        other => Err(anyhow!("unsupported account_type: {other}")),
    }
}
...
pub(crate) fn parse_account_ledger_entry_type(value: &str) -> Result<AccountLedgerEntryType> {
    match value {
        ...
        other => Err(anyhow!("unknown account_ledger_entry_type: {other}")),
    }
}
...
pub(crate) fn parse_request_status(value: &str) -> Result<RequestStatus> {
    match value {
        ...
        other => Err(anyhow!("unknown request_status: {other}")),
    }
}
...
pub(crate) fn parse_usage_capture_status(value: &str) -> Result<UsageCaptureStatus> {
    match value {
        ...
        other => Err(anyhow!("unknown usage_capture_status: {other}")),
    }
}
...
pub(crate) fn parse_account_benefit_type(value: &str) -> Result<AccountBenefitType> {
    match value {
        ...
        other => Err(anyhow!("unsupported account benefit type: {other}")),
    }
}
...
pub(crate) fn parse_account_benefit_source_type(value: &str) -> Result<AccountBenefitSourceType> {
    match value {
        ...
        other => Err(anyhow!("unsupported account benefit source type: {other}")),
    }
}
...
pub(crate) fn parse_account_benefit_lot_status(value: &str) -> Result<AccountBenefitLotStatus> {
    match value {
        ...
        other => Err(anyhow!("unsupported account benefit lot status: {other}")),
    }
}
...
pub(crate) fn parse_account_hold_status(value: &str) -> Result<AccountHoldStatus> {
    match value {
        ...
        other => Err(anyhow!("unsupported account hold status: {other}")),
    }
}
...
pub(crate) fn parse_request_settlement_status(value: &str) -> Result<RequestSettlementStatus> {
    match value {
        ...
        other => Err(anyhow!("unsupported request settlement status: {other}")),
    }
}
...
pub(crate) fn decode_account_benefit_lot_row(row: PgRow) -> Result<AccountBenefitLotRecord> {
...
pub(crate) fn decode_account_hold_row(row: PgRow) -> Result<AccountHoldRecord> {
...
pub(crate) fn decode_account_ledger_entry_row(row: PgRow) -> Result<AccountLedgerEntryRecord> {
...
pub(crate) fn decode_request_meter_fact_row(row: PgRow) -> Result<RequestMeterFactRecord> {
...
pub(crate) fn decode_request_meter_metric_row(row: PgRow) -> Result<RequestMeterMetricRecord> {
...
pub(crate) fn decode_request_settlement_row(row: PgRow) -> Result<RequestSettlementRecord> {
...
pub(crate) fn decode_pricing_plan_row(row: PgRow) -> Result<PricingPlanRecord> {
...
pub(crate) fn decode_pricing_rate_row(row: PgRow) -> Result<PricingRateRecord> {

...
pub(crate) async fn music_minimax_generation_handler(
    request_context: StatelessGatewayRequest,
    request: Request<Body>,
) -> Response {
    relay_stateless_minimax_json_request(request_context, request, "music generation").await
}

pub(crate) async fn music_minimax_lyrics_handler(
    request_context: StatelessGatewayRequest,
    request: Request<Body>,
) -> Response {
    relay_stateless_minimax_json_request(request_context, request, "lyrics generation").await
}

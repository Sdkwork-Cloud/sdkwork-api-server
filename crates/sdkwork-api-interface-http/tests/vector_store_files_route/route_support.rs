...
pub(super) async fn assert_vector_store_file_not_found(
...
pub(super) struct LocalVectorStoreFilesTestContext {
...
pub(super) async fn local_vector_store_files_test_context(
    tenant_id: &str,
    project_id: &str,
